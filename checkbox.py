...
class Checkbox:
    def __init__(self, surface, x, y, color=(150, 150, 255), caption="", outline_color=(0, 0, 0),
                 check_color=(0, 0, 0), font_size=22, font_color=(0, 0, 0), text_offset=(28, 1), checked=False):
        ...
        self.to = text_offset
        # checkbox object
        self.checkbox_obj = pg.Rect(self.x, self.y, 32, 32)
    ...
    def render_checkbox(self):
        if self.checked:
            ...
            pg.draw.rect(self.surface, self.oc, self.checkbox_outline, 2)
            pg.draw.circle(self.surface, self.cc, (self.x + 16, self.y + 16), 4)
